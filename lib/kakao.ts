...
export async function shareInvitation(): Promise<void> {
  try {
    ...
    // The share image is a 1200×630 landscape file generated by
    // scripts/build-og-thumbnail.mjs — KakaoTalk's chat preview slot
    // is locked to a 1.91:1 landscape aspect ratio and crops any image
