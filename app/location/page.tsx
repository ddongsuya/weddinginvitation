  ...
  return (
    <main>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="text-center">
            ...
            <motion.p
              ...
              className="mt-5 text-[19px] tracking-wide text-muted sm:text-xl"
            >
              {venue.hall}
            </motion.p>
          </div>
      ...
      <section className="px-6 pb-20 sm:px-10 sm:pb-28">
        ...
        >
          <p className="text-center text-[19px] tracking-[0.04em] text-muted sm:text-xl">
            지도 앱에서 길찾기
          </p>
          <div className="mt-8 grid grid-cols-2 gap-3 sm:gap-4">
            <motion.a
              ...
              className="rounded-2xl bg-emerald-500 py-5 text-center text-base font-medium text-white shadow-[0_4px_14px_rgba(16,185,129,0.18)] sm:py-7 sm:text-lg"
            >
              네이버지도
            </motion.a>
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              transition={{ type: "spring", stiffness: 320, damping: 22 }}
              className="rounded-2xl bg-yellow-300 py-5 text-center text-base font-medium text-stone-900 shadow-[0_4px_14px_rgba(252,211,77,0.3)] sm:py-7 sm:text-lg"
            >
              카카오맵
            </motion.a>
          </div>
          <motion.button
            ...
            transition={{ type: "spring", stiffness: 320, damping: 22 }}
            className="mt-3 w-full rounded-2xl border border-stone-200 bg-white py-4 text-base text-foreground transition-colors hover:border-stone-300 sm:py-5 sm:text-lg"
          >
...
function InfoRow({
  ...
  return (
    <div className="grid grid-cols-[6rem_1fr] items-baseline gap-x-4 gap-y-1 border-b border-stone-200/70 pb-4 last:border-b-0 last:pb-0 sm:grid-cols-[7rem_1fr]">
      <dt className="font-serif text-[15px] tracking-[0.15em] text-accent sm:text-base">
        {label}
      </dt>
      <dd className="text-[17px] leading-[1.75] tracking-[-0.005em] text-foreground sm:text-lg">
        {value}
      </dd>
    </div>
  );
